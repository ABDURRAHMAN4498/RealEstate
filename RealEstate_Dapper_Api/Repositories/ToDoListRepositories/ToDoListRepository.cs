...
namespace RealEstate_Dapper_Api.Repositories.ToDoListRepositories
{
    public class ToDoListRepository : IToDoListRepository
    {
        ...
        public async Task<List<ResultToDoListDto>> GatAllToDoListAsync()
        {
            string query = "SELECT ToDoListID,Description,ToDoListStatus FROM ToDoList";
        ...
        public Task<ResultToDoListDto> GetToDoList(int id)
        {
            throw new NotImplementedException();
        }
